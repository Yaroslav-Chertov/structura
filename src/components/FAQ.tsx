...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Проверьте папки «Спам» и «Промоакции». Если письма нет, пожалуйста, напишите нам на primer@gmail.com, указав e-mail, который использовался при оплате — мы поможем оперативно.",
  },
];
